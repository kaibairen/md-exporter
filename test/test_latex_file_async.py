"""
Test script for converting LaTeX/formula-heavy markdown files to PDF (Asynchronous)
"""
...
async def test_async_conversion():
    """Test asynchronous PDF conversion for LaTeX-heavy file"""
    input_file = "files/md_test_files/test_zh_latex.md"
    output_file = "files/pdf/test_zh_latex_async.pdf"

    logger.info("=" * 60)
    logger.info("Testing LaTeX-heavy Markdown conversion (ASYNCHRONOUS)")
    logger.info("=" * 60)
