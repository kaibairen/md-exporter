"""
Test script for synchronous PDF conversion
"""
...
def test_sync_conversion():
    """Test synchronous PDF conversion method"""
    input_file = "files/md_test_files/test_report.md"
    output_file = "files/pdf/test_report_sync.pdf"

    logger.info("=" * 60)
    logger.info("Testing SYNCHRONOUS PDF conversion method")
    logger.info("=" * 60)
