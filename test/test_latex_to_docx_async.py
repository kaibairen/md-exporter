"""
Test script for LaTeX to DOCX conversion (Asynchronous)
"""
...
async def test_latex_to_docx_async():
    """Test asynchronous LaTeX to DOCX conversion"""
    input_file = "files/md_test_files/test_zh_latex.md"
    output_file = "files/docx/test_latex_to_docx_async.docx"

    logger.info("=" * 60)
    logger.info("Testing LaTeX to DOCX conversion (ASYNCHRONOUS)")
    logger.info("=" * 60)
...
async def main():
    """Main async function"""
    success, duration = await test_latex_to_docx_async()
